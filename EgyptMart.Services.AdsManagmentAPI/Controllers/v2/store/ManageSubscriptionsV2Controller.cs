...
namespace EgyptMart.Services.AdsManagmentAPI.Controllers.v2.store
{
    [Route("api/store/v2/Ads/ManageSubscriptions")]
    [ApiController]
    public class ManageSubscriptionsV2Controller(IRepositoryWrapper repositoryWrapper) : ControllerBase
    {
