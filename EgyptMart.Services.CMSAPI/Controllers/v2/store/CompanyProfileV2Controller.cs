...
{
    [Route("api/store/v2/CompanyProfile")]
    [ApiController]

    public class CompanyProfileV2Controller : Controller
    {
        private readonly IRepositoryWrapper _repositoryWrapper;
        private readonly ILogger<CompanyProfileController> _logger;
        private readonly IConfiguration _configuration;

        public CompanyProfileV2Controller(IRepositoryWrapper repositoryWrapper, ILogger<CompanyProfileController> logger, IConfiguration iConfig)
        {
