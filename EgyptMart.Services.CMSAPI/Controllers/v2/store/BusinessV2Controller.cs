...
{
    [Route("api/store/v2/Business")]
    [ApiController]
    public class BusinessV2Controller(IRepositoryWrapper _repositoryWrapper, ILogger<CompanyProfileController> _logger) : ControllerBase
    {
