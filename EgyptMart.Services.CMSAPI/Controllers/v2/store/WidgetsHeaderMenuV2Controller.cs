...
{
    [Route("api/store/v2/WidgetsHeaderMenu")]
    [ApiController]
    //[EnableRateLimiting("IpRateLimit")]
    public class WidgetsHeaderMenuV2Controller : Controller
    {
        private readonly IRepositoryWrapper _repositoryWrapper;
        private readonly ILogger<WidgetsHeaderMenuController> _logger;

        public WidgetsHeaderMenuV2Controller(IRepositoryWrapper repositoryWrapper, ILogger<WidgetsHeaderMenuController> logger)
        {
