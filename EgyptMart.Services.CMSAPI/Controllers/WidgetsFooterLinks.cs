...
namespace EgyptMart.Services.CMSAPI.Controllers.V1
{
    [Route("api/v1/WidgetsFooterLinks")]
    [ApiController]
    public class WidgetsFooterLinksController : ControllerBase
    {
        private readonly IRepositoryWrapper _repositoryWrapper;

        public WidgetsFooterLinksController(IRepositoryWrapper repositoryWrapper)
        {
