...
{
    [Route("api/v1/WidgetsSocialMedia")]
    [ApiController]
    public class WidgetsSocialMediaController : Controller
    {
        private readonly IRepositoryWrapper _repositoryWrapper;
        private readonly ILogger<WidgetsSocialMediaController> _logger;

        public WidgetsSocialMediaController(IRepositoryWrapper repositoryWrapper, ILogger<WidgetsSocialMediaController> logger)
        {
