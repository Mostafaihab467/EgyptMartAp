...
{
    [Route("api/v1/StoreFrontWidgets")]
    [ApiController]
    public class StoreFrontWidgetsController : ControllerBase
    {
        private readonly IRepositoryWrapper _repositoryWrapper;


        public StoreFrontWidgetsController(IRepositoryWrapper repositoryWrapper)
        {
