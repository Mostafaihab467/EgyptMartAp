...
namespace EgyptMart.Services.Auth.Controllers
{
    ...
    [ApiController]
    public class RecoveryController(IRecoveryRepository recoveryRepository, IAccountsRepository accountRepository, IEmailService emailService) : ControllerBase
    {
