...
{
    [Route("api/store/v2/ProductImages")]
    [ApiController]

    public class ProductImagesV2Controller : Controller
    {
        private readonly IRepositoryWrapper _repoWrapper;
        private readonly IConfiguration _configuration;

        public ProductImagesV2Controller(IRepositoryWrapper repoWrapper, IConfiguration iConfig)
        {
        ...
        public async Task<IActionResult> Upload3DModel([Required][MinValidator(1)] long ProductID, [FromBody][Required] string ModelBase64)
        {

            try
            {

                Stream stream = new MemoryStream(Convert.FromBase64String(ModelBase64));
